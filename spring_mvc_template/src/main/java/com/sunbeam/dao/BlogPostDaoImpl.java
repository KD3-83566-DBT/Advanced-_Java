...
private SessionFactory factory;
	...
	public BlogPost getBlogPostByTitle(String title) {
		BlogPost post=null;
		String jpql="select p from BlogPost p where p.title=:title";
		return factory.getCurrentSession().createQuery(jpql,BlogPost.class).setParameter("title", title).getSingleResult();
	}
